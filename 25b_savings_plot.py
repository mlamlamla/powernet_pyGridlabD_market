...
# Builds on 25b_householdsavings_compile.py
...
df_results = pd.read_csv(run + '/' + 'weekly_welfare_changes_b.csv',index_col=[0]) # from 25b_householdsavings_compile.py
...
ppt.savefig(folder_WS+'/25b_hist_wchange_year.png', bbox_inches='tight')
ppt.savefig(folder_WS+'/25b_hist_wchange_year.pdf', bbox_inches='tight')
...
ppt.savefig(folder_WS + '/25b_wchange_meanp.png', bbox_inches='tight')
ppt.savefig(folder_WS + '/25b_wchange_meanp.pdf', bbox_inches='tight')
...
ppt.savefig(folder_WS + '/25b_wchange_stdp.png', bbox_inches='tight')
ppt.savefig(folder_WS + '/25b_wchange_stdp.pdf', bbox_inches='tight')
...
ax.set_ylabel('Aggregate welfare change in a week [USD]')
ppt.savefig(folder_WS + '/25b_wchange_varp.png', bbox_inches='tight')
ppt.savefig(folder_WS + '/25b_wchange_varp.pdf', bbox_inches='tight')
